...
| `OPENAI_API_KEY` | **Yes** | Production only | `sk-proj-...` | OpenAI API key for the AI Coach feature. Found in platform.openai.com → API Keys. |
...
| `OPENAI_API_KEY` | ✓ | — (optional for preview) | — |
| `OPENAI_MODEL` | ✓ | ✓ | — |
